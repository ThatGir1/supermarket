# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-23 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('img_url', models.ImageField(upload_to='goods_gallery/%Y%m/%d', verbose_name='相册地址')),
            ],
            options={
                'verbose_name': '商品相册管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Category', verbose_name='商品分类id')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='goods_spu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods_Spu', verbose_name='商品Spuid'),
        ),
        migrations.AddField(
            model_name='goods_sku',
            name='unit',
        ...
        migrations.AddField(
            model_name='album',
            name='goods_sku',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods_Sku'),
        ),
        migrations.AddField(
